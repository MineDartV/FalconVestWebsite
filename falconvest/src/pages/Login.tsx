      ...
      <div className="container mx-auto max-w-md">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-dark-600">Log in to your FalconVest account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 text-primary-400 border-dark-300 rounded focus:ring-primary-400"
                />
          ...
          <div className="mt-8 pt-6 border-t border-dark-200">
            <div className="text-center text-sm text-dark-500 mb-4">Or continue with</div>
